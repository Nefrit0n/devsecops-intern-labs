...
Это обучающий репозиторий для начинающих DevSecOps-инженеров. Здесь вы пройдёте путь от теории ГОСТа до сборки полноценного CI/CD пайплайна с инструментами безопасности — и поймёте, зачем нужен каждый шаг.
...
CI/CD с quality gates, DefectDojo, метрики безопасности.
