...
-   :material-tools:{ .lg .middle } **50+ инструментов**

    ---

    Semgrep, Trivy, ZAP, Nuclei, Falco, DefectDojo и десятки других — все open-source
...
-   :material-docker:{ .lg .middle } **Одна команда**

    ---

    `docker compose up` — и вся среда поднята. Makefile для каждого этапа

-   :material-certificate:{ .lg .middle } **7000+ строк контента**

    ---

    Не видео-курс, а практический полигон: задания, шаблоны, эталонные решения
